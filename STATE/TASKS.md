...
- [ ] P2-8 [S8-prep] Two clips × 3 rigs + side-by-side GIFs + metric in docs. media: side-by-side GIFs. — PREP DONE S8: real-walk clip search exhausted -> NEEDS-HUMAN (out/video_smoke/SOURCES.md; mmpose demo.mp4 = 1 s @ 5 fps, too short); instruments stay synthetic-labeled (hip_stab_gate + foot_lock_gate blocks in BENCHMARKS.md are the metric harnesses a real clip re-runs). Remaining: the clips themselves, retarget across 3 rigs, GIFs.
