...
- [ ] P6-3 Public benchmark suite packaging.
  - UNBLOCKED (D-020, 2026-09-23): the 7 licensing questions are answered
    — CC0 suite, ControlNet + BY-SA slots replaced, LO reviews the photo
    set at packaging time, in-repo docs/ distribution, the suite becomes
    the CI gate fixture, P2-8 retired as satisfied-by-Xbot. Work order
    material for S26+ (see NEXT.md work order B).
